...
<form action="<?php echo base_url(); ?>backend/counter/cek" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary" id="demo">
                            <div class="panel-heading">
                                <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Counter Menu</h3>
          ...
          <input type="submit" name="submit" formaction="<?php echo site_url('backend/label/export_to_pdf'); ?>" formtarget="_blank" class="btn btn-s-md btn-info" value="MULTIPLE GENERATE TO PDF">
            ...
            <select class="input-sm form-control input-s-sm inline v-middle" id="jenis">
                 <option value="null">customradio1</option>
                  <option value="counter">label</option>
            ...
            <font id="counter" class="drop-down-show-hide">
          ...
          ;
                  ...
                  <th>
                   <th  style="width:10%"><?php echo ($page+$i+1); ?></th>
                       <th  style="width:30%"><?php echo word_limiter($counter[$i]["title"],5); ?></th>
                       <th  style="width:30%"><?php echo word_limiter($counter[$i]["description"], 10); ?></th>
                        <th  style="width:30%"><img src="<?php echo base_url();?>assets/foto/<?php echo $counter[$i]["foto"];?>" width="60" height="60" onError="this.onerror=null;this.src='<?php echo base_url();?>assets/foto/foto.jpg';" width="60" height="60" /></th>
                       <th  style="width:30%"><?php echo $counter[$i]["counter"]; ?> kali.</th>
                       </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
