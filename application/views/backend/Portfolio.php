...
<body> 
<div class="row">    
      <form data-validate="parsley" action="<?php echo base_url(); ?>backend/portfolio/proses" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                          ...
                          <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Portfolio</h3>
                            ...
                            <div class="panel-toolbar text-left"></div>
                                  ...
                                  <select name="id_category_portfolio" class="form-control">
                                   <?php foreach($list_category_portfolio as $list_category_portfolio){ ?>
                ...
                <?php echo form_error('description'); ?></div></div></br></br></br></br></br> 
