...
<body> 
<div class="row">    
      <form data-validate="parsley" action="<?php echo base_url(); ?>backend/article/proses" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                          ...
                          <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Article</h3>
                            ...
                            <div class="panel-toolbar text-left">
                                  <div class="btn-group">
                                      ...
                                      <label>Category</label><input type="hidden" name="id" value="<?php echo set_value('id'); ?>"/>
