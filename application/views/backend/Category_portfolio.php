<div class="row">                  
      <form data-validate="parsley" action="<?php echo base_url(); ?>backend/category_portfolio/proses" method="post" enctype="multipart/form-data">
              <div class="col-md-12">
                          ...
                          <h3 class="panel-title"><span class="panel-icon mr5"><i class="ico-table22"></i></span> Category Portfolio</h3>
                            ...
                            <div class="panel-toolbar text-left"></div>
                                  <div class="btn-group"></div>
                                      ...
                                      <label>Category</label><input type="hidden" name="id_category_portfolio" value="<?php echo set_value('id_category_portfolio'); ?>"/>
