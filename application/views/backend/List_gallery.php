                    ...
                    <div class="col-md-12">
                        <div class="panel panel-info" id="demo">
                            <div class="panel-heading">
                                ...
                                <div class="panel-toolbar text-right">
                                    <div class="btn-group">
                                   <a type="button" class="btn btn-sm btn-success" data-toggle="tooltip" data-placement="left" title="Add data?" href="<?php echo base_url('backend/gallery');?>"><i class="icon ico-pencil"></i> Add Data ?</a>
                                </div>
                            </div>
                            <div class="table-responsive panel-collapse pull out">
                               <div class="col-md-4">
                                  <select class="form-control mt4" name="action">
                                    ...
                                    <input type="submit" id="selected" name="selected" class="btn btn-s-md btn-info" formaction="<?php echo base_url(); ?>backend/gallery/delete_multiple" value="ACTION"><p align="right"></p>
          ...
          <input type="submit" name="submit" formaction="<?php echo site_url('backend/label/export_to_pdf'); ?>" formtarget="_blank" class="btn btn-s-md btn-info" value="MULTIPLE GENERATE TO PDF">
            ...
            <select class="input-sm form-control input-s-sm inline v-middle" id="jenis">
                 <option value="null">customradio1</option>
                  <option value="gallery">label</option>
            ...
            <font id="gallery" class="drop-down-show-hide">
          ...
          ;
                  ...
                  <table class="table table-striped table-bordered table-hover" id="row-detail">
                    <thead>
                      <tr>
                        ...
                        <th class="th-sortable" data-toggle="class" style="width:10%">No
                          ...
                          <th class="th-sortable" data-toggle="class"  style="width:30%">Author<span class="th-sort">
                          </span></th>
                          <th class="th-sortable" data-toggle="class"  style="width:30%">Date Post<span class="th-sort">
                          </span></th>
                          ...
                          </span></th> <!-- <th class="th-sortable" data-toggle="class"  style="width:30%">File<span class="th-sort">
                          </span></th> -->
                    ...
                    if(empty($gallery))
                     ...
                     <tr>
                  <th>
               <input type="checkbox" name="selected[]" id="selected-<?php echo $selected; ?>" class="selected" value="<?php echo $gallery[$i]["id"]; ?>" data-toggle="checkall" data-target="#table1">  
                   <th  style="width:10%"><?php echo ($page+$i+1); ?></th>
                    <th  style="width:30%"><?php echo $gallery[$i]["category"]; ?></th>
                    <th  style="width:30%"><?php echo $gallery[$i]["status"]; ?></th>
                    <th  style="width:30%"><?php echo $gallery[$i]["author"]; ?></th>
                    <th  style="width:30%"><?php echo $gallery[$i]["date_post"]; ?></th>
                    <th  style="width:30%"><?php if($gallery[$i]["counter"] == 0){
                      echo 'Belum Pernah Dilihat';
                      }
                      else{
                        echo $gallery[$i]["counter"];
                        echo "kali.";
                    } ?> </th>
                       <th  style="width:30%"><?php echo word_limiter($gallery[$i]["title"],5); ?></th>
                       <th  style="width:30%"><?php echo word_limiter($gallery[$i]["description"], 20); ?></th>
                     <!-- <th  style="width:30%">  
                      
                      <?php if($gallery[$i]["file"] == null){
                      ...
                      elseif($gallery[$i]["category"] == 'Foto'){
                          echo '<p align="center"><img src="'.base_url().'assets/files/'.$gallery[$i]["file"].'" width="180" height="100" ></p>';
                        ?>
                      <?
                       }
                        elseif($gallery[$i]["category"] == 'Video' || $gallery[$i]["category"] == 'Audio' ){
                        ?>
                         <video id="video1" class="video-js vjs-default-skin" width="180" height="100" poster="<?php echo base_url(); ?>site/img/logoheader.png"
                            data-setup='{"controls" : true, "autoplay" : false, "preload" : "auto"}'>
                             <source src="<?php echo base_url(); ?>assets/files/<?php echo $gallery[$i]["file"];?>" type="video/x-flv">
                            <source src="<?php echo base_url(); ?>assets/files/<?php echo $gallery[$i]["file"];?>" type='video/mp4'>
                        </video>
                        <?php
                        }
                      ?>
                    </th> -->
                       <th  style="width:30%">   <a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/gallery/edit_gallery');?>/<?php echo $gallery[$i]["id"] ?>">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Delete Data?" href="<?php echo base_url('backend/gallery/delete');?>/<?php echo $gallery[$i]["id"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');">Delete</a></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
