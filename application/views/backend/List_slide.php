          ...
          <input type="submit" name="submit" formaction="<?php echo site_url('backend/label/export_to_pdf'); ?>" formtarget="_blank" class="btn btn-s-md btn-info" value="MULTIPLE GENERATE TO PDF">
            ...
            <select class="input-sm form-control input-s-sm inline v-middle" id="jenis">
                 <option value="null">customradio1</option>
                  <option value="slide">label</option>
            ...
            <font id="slide" class="drop-down-show-hide">
               ...
               <input type="checkbox" name="selected[]" id="selected-<?php echo $selected; ?>" class="selected" value="<?php echo $slide[$i]["id"]; ?>" data-toggle="checkall" data-target="#table1">  
                   <th  style="width:10%"><?php echo ($page+$i+1); ?></th>
                       ...
                       <th  style="width:30%"><?php echo word_limiter($slide[$i]["description"], 10); ?></th>
                          <th  style="width:30%"><img src="<?php echo base_url();?>assets/foto/<?php echo $slide[$i]["foto"];?>" width="60" height="60" onError="this.onerror=null;this.src='<?php echo base_url();?>assets/foto/foto.jpg';" width="60" height="60" /></th>
                       <th  style="width:30%">   <a type="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="left" title="Update data?" href="<?php echo base_url('backend/slide/edit_slide');?>/<?php echo $slide[$i]["id"] ?>">Update</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" data-placement="right" title="Delete Data?" href="<?php echo base_url('backend/slide/delete');?>/<?php echo $slide[$i]["id"] ?>"onClick="return confirm('Anda Yakin Akan Menghapus Data Ini?');">Delete</a></th>
                   </tr> 
                   <?php
                    $selected++;
                       $selected = $selected++;
